...
## 🧾 Générer des Bibliographies Automatiques et Normalisées
**🎯 Cas d’usage :**  
Vous gagnez du temps en générant directement vos références bibliographiques aux formats APA, MLA, Chicago, etc.

**💬 Prompt utile :**  
> "Génère la bibliographie de toutes les sources utilisées selon le style APA 7."

**✅ Résultat :**  
- Références prêtes à être copiées dans votre mémoire.  
- Aucune erreur de style.

---

## 🎬 Créer des Présentations Automatisées à Partir de vos Sources
**🎯 Cas d’usage :**  
Préparer un exposé ou une présentation sans passer des heures à tout résumer et structurer.

**💬 Prompt utile :**  
> "Crée une présentation de 5 diapositives sur le thème : [ex. ‘Les attaques adversariales en IA’] à partir des documents importés."

**✅ Résultat :**  
- Diapositives avec titres, points clés et citations.  
- Exportable vers Google Slides ou PowerPoint.
